...
public class Lambda02 {
    ...
    public static void ciftKarePrint(List<Integer> sayi) {
        sayi.
                ...
                map(t -> t * t).                //Stream icindeki sayilari baska degerlere donusturur    16,4,36
    ...
    public static void structuredMAxElBul(List<Integer> sayi) {
        ...
        for (int i = 0; i < sayi.size(); i++) {
            if (sayi.get(i) > max) max = sayi.get(i);   //if den sonrasi tek satirsa curlybrace ye gerek yok
        }
